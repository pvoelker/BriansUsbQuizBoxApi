...
namespace BriansUsbQuizBoxApi
{
    ...
    public class BuzzInStatsEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Winner paddle number that was pressed. Zero if no winner
        /// </summary>
        ...
        /// <param name="winnerPaddleNumber">Winner paddle number that was pressed. Zero if no winner</param>
        ...
        public BuzzInStatsEventArgs(PaddleColorEnum winnerPaddleColor, int winnerPaddleNumber,
